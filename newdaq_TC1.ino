// new dc offset 6/11/2025, bug fix 10/21/2025
...
void setup() {
  ...
  //  estimate DC offset, average 200x128 ADC samples at 75Hz (~2 seconds)
...
void loop() {
  ...
  // decimate the two outputs above and compute result
